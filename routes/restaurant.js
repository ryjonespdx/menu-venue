...
router.get('/:id/menu/all', menu_controller.menu_list);

// GET request for creating a Menu. NOTE This must come before routes that display Menu (uses id).
router.get('/:id/menu/create', menu_controller.menu_create_get);

// POST request for creating Menu.
router.post('/:id/menu/create', menu_controller.menu_create_post);

// GET request to delete Menu.
router.get('/:id/menu/:menu_id/delete', menu_controller.menu_delete_get);

// POST request to delete Menu.
router.post('/:id/menu/:menu_id/delete', menu_controller.menu_delete_post);

// GET request to update Menu.
router.get('/:id/menu/:menu_id/update', menu_controller.menu_update_get);

// POST request to update Menu.
router.post('/:id/menu/:menu_id/update', menu_controller.menu_update_post);

// GET request for one Menu.
router.get('/:id/menu/:menu_id', menu_controller.menu_detail)
